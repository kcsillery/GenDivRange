# ###################################################################################
# WORLD GENETICS: Filtering GBIF observations further using Priscilla's script
#
# $Date: 2022-07-08
#
...
# 
# Description: New GBIF observations were downloaded and are now finished. I want here
# to filtered the GBIF observations (with priscilla pipelines)
#
# ###################################################################################
